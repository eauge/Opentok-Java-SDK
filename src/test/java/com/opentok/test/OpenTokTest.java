...
public class OpenTokTest {
    ...
    private int port =  System.getenv().containsKey("PORT") ?
    		Integer.parseInt(System.getenv().get("PORT")) : 61234;
    private String defaultApiUrl = "http://localhost:" + Integer.toString(port);
